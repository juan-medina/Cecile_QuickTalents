...
L["UI_CLOSE"] = "Close"
L["UI_CLOSE_TOOLTIP"] = {"Close the window"," ",{shortcut,"ESCAPE",1,1,1,1,1,1}}
L["UI_ACTIVATE"] = "activate"
L["UI_ACTIVATE_TOOLTIP"] = {"Activate this talents"," ",{shortcut,"ENTER",1,1,1,1,1,1}}
L["UI_CURRENT"] = "current"
L["UI_CURRENT_TOOLTIP"] = {"Set this talents to be your current"," ","$"," ",{shortcut,"DELETE/BACKSPACE",1,1,1,1,1,1}}
L["UI_COPY"] = "copy"
L["UI_COPY_TOOLTIP"] = {"Copy this talents"," ",{shortcut,"CTRL+C",1,1,1,1,1,1}}
L["UI_PASTE"] = "paste"
L["UI_PASTE_TOOLTIP"] = {"Paste the copied talents"," ","$"," ",{shortcut,"CTRL+V",1,1,1,1,1,1}}
...
L["UI_EXPAND_PLUS_DESC"] = {"Expand the window to see additional options"," ",{shortcut,"SPACE",1,1,1,1,1,1}}
L["UI_EXPAND_LESS_DESC"] = {"Restore the window to normal size"," ",{shortcut,"SPACE",1,1,1,1,1,1}}

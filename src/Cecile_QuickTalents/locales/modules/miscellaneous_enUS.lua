...
L["MISCELLANEUS_SHOW_ACTIVE_INACTIVE"] = "Extended Tooltip"
L["MISCELLANEUS_SHOW_ACTIVE_INACTIVE_DESC"] = "Toggle to show more information on databroker and minimap button tooltips"
L["MISCELLANEUS_ADD_TALENTS_PANEL_BUTTON"] = "Talent Panel Button"
L["MISCELLANEUS_ADD_TALENTS_PANEL_BUTTON_DESC"] = "Add a quick access button to blizzard talents window"